...
import { House, Landmark, Monitor, Receipt, Tags, Wallet } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen">
      {/*
        ...
        every other app's AppShell. Colors below are literal, not the shared
      ...
      */}
      <aside className="flex w-56 shrink-0 flex-col border-r border-[#7a5738]/12 bg-[#10190f] text-[#f6efe1]">
        <div className="flex items-center gap-2 px-5 py-6">
          <Wallet size={20} className="text-[#8ea377]" strokeWidth={1.75} />
          <span className="font-serif text-[1.05rem] tracking-tight">Ledger</span>
        </div>
